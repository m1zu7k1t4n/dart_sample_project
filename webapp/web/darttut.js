...
(function dartProgram() {
  ...
  O = {
    main: function() {
      ...
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(O.darttut__getSum$closure(), {func: 1, ret: -1, args: [t2]}), false, t2);
    },
    getSum: function($event) {
      ...
      t1.querySelector("#sum").textContent = "" + num1 + " + " + num2 + " = " + sum;
    }
  };
  ...
  (function installTearOffs() {
    ...
    _static_1(O, "darttut__getSum$closure", "getSum", 11);
  })();
